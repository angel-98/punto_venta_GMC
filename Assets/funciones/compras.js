...
function clean(){
	...
	$("#most_imp").html('0.00')
	$("#valor_impuesto").html(tax_current+" 0%");
}
/*=============================================================================
=============================================================================*/
function hideform(){
		...
		buttons: [
			{
				...
				title: company + ' - Reporte de Compras',
			},
			{
				extend: 'csvHtml5',
...
$(document).on('submit', '#form', function(e){
	...
	var igv = $('#igv').val();
	if(proveedor != '0' && fecha != '' && tipo_documento != '' && num_documento != '' && serie !='' && igv != '' && tabla != ''){
		...
		Swal.fire({
			...
			text: "Al realizar la compra,no se podra efectuar ningún cambio...",
			icon: 'warning',
