<?php
    ...
    if(!isset($_SESSION['token_str'])){
        ...
        if ($_SESSION['type_str']=="Administrador") 
        {
            ...
            class PDF extends FPDF
            {
                ...
                function Header()
                {
                    if ($this->page == 1)
                    {
                        ...
                        $this->Cell(98);
                        // Title
                        $this->Cell(115,10,strtoupper(utf8_decode("Reporte de compras - ".$informacion["empresa_nombre"])),0,0,'C');
                        // Line break
                        $this->Ln(20); 
                    }
                }
            ...
            $listado = $compras->reporte_compras_model();
            try {
                ...
                $pdf->Output('I','reporte_de_compras.pdf');
