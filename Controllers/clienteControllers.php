        ...
        public function list_client_controller(){
            ...
            while ($reg=$query->fetch()) {
                $data[]=array(
                    ...
                    '<div class="btn-group">
                    <button type="button" class="btn btn-default border-info btn-sm edit" title="Actualizar" id="'.mainModel::encryption($reg['cliente_id']).'">
                    <i class="fa fa-edit fa-xs"></i>
                    </button>'.' '.' 
                    <button type="button" class="btn btn-default border-danger btn-sm delete" title="Eliminar" id="'.mainModel::encryption($reg['cliente_id']).'">
                    <i class="fa fa-trash fa-xs"></i>
                    </button></div>':'<div class="btn-group">
                    <button type="button" class="btn btn-default border-info btn-sm denegado" title="Actualizar">
                    <i class="fa fa-edit fa-xs"></i>
                    </button>'.' '.' 
                    <button type="button" class="btn btn-default border-danger btn-sm denegado" title="Eliminar">
                    <i class="fa fa-trash fa-xs"></i>
                    </button></div>',
