    ...
    class categoriaControllers extends categoriaModels{
        ...
        public function list_cate_controller(){
            ...
            while ($reg=$query->fetch()) {
                $data[]=array(
                    "0"=>                  
                    '<div class="btn-group"><button title="Actualizar" class="btn btn-default border-info btn-sm edit" title="Edit" id="'.mainModel::encryption($reg['tipo_id']).'">
                    <i class="fa fa-edit fa-xs"></i>
                    </button>'.' '.' 
                    <button type="button" title="Eliminar" class="btn btn-default border-danger btn-sm delete" title="Remove" id="'.mainModel::encryption($reg['tipo_id']).'">
