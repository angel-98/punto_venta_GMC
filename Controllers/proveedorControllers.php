        ...
        public function list_provee_controller(){
            ...
            while ($reg=$query->fetch()) {
                $data[]=array(
                    "0"=>
                    '<div class="btn-group">
                    <button type="button" class="btn btn-default border-info btn-sm edit" title="Actualizar" id="'.mainModel::encryption($reg['proved_id']).'">
                    <i class="fa fa-edit fa-xs"></i>
                    </button>'.' '.' 
                    <button type="button" class="btn btn-default border-danger btn-sm delete" title="Eliminar" id="'.mainModel::encryption($reg['proved_id']).'">
                    ...
                    "5"=>$reg['proved_correo'], 
                    "6"=>limitar_cadena($reg['proved_direccion'],25,"...")
                );
            }
            $results=array(
                     "sEcho"=>1,
